const { interpolateKeyframes } = require('../utils/interpolateKeyframes.js');
const { renderPolaroidPicture } = require('./renderPolaroidPicture.js');

module.exports = function renderThreePictures(context, image1, image2, image3, width, height, time) {
